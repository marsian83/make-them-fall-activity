...
class settings:
    ...
    def run(self, gameDisplay, bg_dimensions, offset, config):
        ...
        while self.running:
            ...
            # Draw background
            pygame.draw.rect(gameDisplay, bg_color, pygame.Rect(offset[0], offset[1], bg_dimensions[0], bg_dimensions[1]))
            ...
            self.buttons[1].text = font1.render(["Easy", "Normal", "Hard"][self.config["difficulty"]], True, black)
